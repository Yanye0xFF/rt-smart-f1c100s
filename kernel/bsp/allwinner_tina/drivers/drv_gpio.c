...
static rt_uint32_t gpio_vbase;

#define GPIOn_CFG_ADDR(n)        (gpio_vbase + (n) * 0x24 + 0x00)
#define GPIOn_DATA_ADDR(n)       (gpio_vbase + (n) * 0x24 + 0x10)
#define GPIOn_DRV_ADDR(n)        (gpio_vbase + (n) * 0x24 + 0x14)
#define GPIOn_PUL_ADDR(n)        (gpio_vbase + (n) * 0x24 + 0x1C)
#define GPIOn_INT_CFG_ADDR(n)    (gpio_vbase + 0x200 + (n) * 0x20 + 0x00)
#define GPIOn_INT_CTRL_ADDR(n)   (gpio_vbase + 0x200 + (n) * 0x20 + 0x10)
#define GPIOn_INT_STA_ADDR(n)    (gpio_vbase + 0x200 + (n) * 0x20 + 0x14)
#define GPIOn_INT_DEB_ADDR(n)    (gpio_vbase + 0x200 + (n) * 0x20 + 0x18)
...
int rt_hw_gpio_init(void)
{
    ...
    gpio_vbase = platform_get_periph_vaddr(F1C100S_PIO_BASE);
