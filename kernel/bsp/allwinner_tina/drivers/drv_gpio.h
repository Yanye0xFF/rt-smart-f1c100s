...
/* IO default function */
#define IO_INPUT         (0x00) // 000
#define IO_OUTPUT        (0x01) // 001
#define IO_DISABLE       (0x07) // 111

/* IO extend function */
#define IO_FUN_1         (0x02) // 010
#define IO_FUN_2         (0x03) // 011
#define IO_FUN_3         (0x04) // 100
#define IO_FUN_4         (0x05) // 101
#define IO_FUN_5         (0x06) // 110
